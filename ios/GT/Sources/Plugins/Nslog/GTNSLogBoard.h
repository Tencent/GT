...
#import "GTPluginViewController.h"
...
@interface GTNSLogCell : GTCommonCell
{
    NSUInteger  _row;
}
...
@interface GTNSLogBoard : GTPluginViewController <UITableViewDataSource, UITableViewDelegate, GTUITableViewTouchesDelegate>
{
