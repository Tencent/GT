...
@interface GTCrashDetailBoard ()

@end

@implementation GTCrashDetailBoard
...
- (void)initUI
{
	...
	_textView.textColor = M_GT_CELL_TEXT_COLOR;
	_textView.font = [UIFont systemFontOfSize:12.0f];
	_textView.delegate = self;
	_textView.backgroundColor = M_GT_CELL_BKGD_COLOR;
    _textView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
    
	NSString *textToAdd = [GTCrashFileHandler readCrashDetail:_filePath];
    [_textView setText:textToAdd];
