...
@protocol GTParaOutputCellDelegate <NSObject>
...
@interface GTParaOutputCell : GTCommonCell
{
	UILabel *		_title;
    UILabel *       _value;
    UILabel *       _historyCount;
	UIButton *      _btnTop;
    UIButton *      _btnChecked;
    NSIndexPath    *_indexPath;
    id<GTParaOutputCellDelegate> _delegate;
}

@property (nonatomic, retain) NSIndexPath *indexPath;
@property (nonatomic, assign) id<GTParaOutputCellDelegate> delegate;
