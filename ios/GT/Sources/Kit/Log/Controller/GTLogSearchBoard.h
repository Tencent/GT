...
@interface GTLogSearchBoard : GTUIViewController <UITableViewDataSource, UITableViewDelegate, GTLogSearchDelegate, GTUITableViewTouchesDelegate>
{
    NSMutableArray  *_array;
    GTLogSearchView *_searchView;
