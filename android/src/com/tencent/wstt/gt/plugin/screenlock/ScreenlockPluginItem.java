...
public class ScreenlockPluginItem extends PluginItem {
	...
	{
		super("screekLock",
				GTApp.getContext().getString(R.string.pi_sclock_title),
				GTApp.getContext().getString(R.string.pi_sclock_item),
			R.drawable.pi_screenlock,
			GTScreenlockActivity.class);
	}
}
