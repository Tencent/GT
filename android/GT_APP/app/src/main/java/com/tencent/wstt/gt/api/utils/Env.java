...
public class Env {
	...
	// GTR测试数据的临时保存路径
	public static final String GTR_PATH = SDCardPathHelper.getAbsoluteSdcardPath() + "/GTR";

	// GTR测试数据的默认导出路径
    public static final String GTR_DATA_PATH = SDCardPathHelper.getAbsoluteSdcardPath() + "/GTRData";

	// GTR测试数据的默认导出路径
	public static final String GTR_DATAJS_PATH_NAME = GTR_DATA_PATH + "/data.js";

	// GTR测试数据的默认导出路径
	public static final String GTR_WX_DATAJS_PATH_NAME = SDCardPathHelper.getAbsoluteSdcardPath() + "/GT/Temporary/data.js";

	// GTR测试数据的默认压缩数据名称
	public static final String GTR_ZIP_DATAJS_PATH_NAME = SDCardPathHelper.getAbsoluteSdcardPath() + "/GT/Temporary/GTRData.zip";

	// GTR解析数据时的默认等待文字
	public static final String GTR_DATA_DEFAULT_MESSAGE = "loading...";
