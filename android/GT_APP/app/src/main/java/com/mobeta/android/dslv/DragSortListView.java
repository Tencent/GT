...
public class DragSortListView extends ListView {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                if (child != oldChild) {
                	...
                	{
                		((DragSortItemView)child.getParent()).removeView(child);
                	}
                    if (oldChild != null) {
                        v.removeViewAt(0);
                    }
    ...
    public interface FloatViewManager {
         ...
         * properties can be onDataChanged here. Also, the upcoming location
    ...
    public void moveCheckState(int from, int to) {
        ...
        // onDataChanged state. This is achieved by building a list containing the
