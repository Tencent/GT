...
public class FragmentAnalysis {
    ...
    public FragmentAnalysis(GTRAnalysis gtrAnalysis, ArrayList<FragmentInfo> fragmentInfos, ArrayList<Integer> overFragments) {
