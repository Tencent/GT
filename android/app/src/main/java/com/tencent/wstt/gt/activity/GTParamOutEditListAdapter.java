...
/**
 * 注意：该Adapter无法简单的用缓存方式，会和TouchInterceptorOut冲突
 */
public class GTParamOutEditListAdapter extends GTParamListBaseAdapter
{
	public GTParamOutEditListAdapter(Context context, List<OutPara> list)
	{
		super(context, list);
	}
