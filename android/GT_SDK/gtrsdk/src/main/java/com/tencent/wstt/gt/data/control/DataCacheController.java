...
public class DataCacheController {
	 ...
	 * 只有在Connecting态才应该走缓存，Connected态应直接送队列
	 */
	public void setOutParaToCache(String paraName, Object value, Object ...extras) {
		if (null != value) {
			outParaCache.put(paraName, value.toString(), extras);
		}
		outParaCache.put(paraName, "", extras);
	}
