...
/**
* @Description 从swt表格中拷贝数据 
* @date 2013年11月10日 下午6:02:08 
*
 */
public class CopyAllFromTableViewAction extends Action {
	
	TableViewer viewer;
	private Clipboard clipboard;
	
	public CopyAllFromTableViewAction(TableViewer viewer)
	{
		this.viewer = viewer;
	}
	...
	private StringBuffer getContents()
	{
		...
		for(int i = 0; i < itemCount; i++)
		{
			...
			{
				sb.append(table.getItem(i).getText(j));
				sb.append(SourceDataItem.SPLIT);
			}
			sb.deleteCharAt(sb.length() - 1);
			sb.append("\r\n");
