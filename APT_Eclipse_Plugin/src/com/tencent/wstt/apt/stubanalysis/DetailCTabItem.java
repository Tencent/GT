...
/**
* @Description 展示APT插桩数据的详细页面 
* @date 2013年11月10日 下午6:04:46 
*
 */
public class DetailCTabItem extends CTabItem {
	private static final String TAB_NAME = StubAnalysisUtil.DETAIL_TAB_NAME;
	private TableViewer viewer = null;
	
	private static final String[] COLUMN_NAME = {"时间戳","进程号","线程号","序号","采样点","被测项","值"};
	private static final int[]COLUMN_WIDTH = {200,50,50,50,50,600,150};
	 

	public DetailCTabItem(CTabFolder parent, int style) {
		super(parent, style);
		this.setText(TAB_NAME);
		this.setImage(AbstractUIPlugin.imageDescriptorFromPlugin(Constant.PLUGIN_ID, "icons/detail.png").createImage());
	...
	class ViewLabelProvider extends LabelProvider implements ITableLabelProvider {
		public String getColumnText(Object obj, int index) {
			if(index == SourceDataItem.SAMPLING_POSITION)
			{
				return SourceDataItem.samplingPositionMap.get(((SourceDataItem)obj).contents[index]);
			}
			return ((SourceDataItem)obj).contents[index];
		}
	...
	public class TableSorter extends ViewerSorter {
		...
		public int compare(Viewer viewer, Object e1, Object e2) {
		   ...
		   SourceDataItem p1 = (SourceDataItem) e1;
		   SourceDataItem p2 = (SourceDataItem) e2;
		   if(p1 == null || p2 == null)
		   {
			   // TODO: 这种情况最好显示信息
			   return 0;
