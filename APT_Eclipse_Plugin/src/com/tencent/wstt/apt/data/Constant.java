...
public final class Constant {
	 ...
	 * 内存测试相关
	 */
	public final static int ALL_MEM_KIND_COUNT = 12;
	...
	public final static int HEAPSIZE_NATIVE_INDEX = 9;
	public final static int HEAPSIZE_DALVIK_INDEX = 10;
	public final static int HEAPSIZE_TOTAL_INDEX = 11;

	public final static String MEM_ITEM_TITLES[] = { "PrivNative", "PrivDalvik",
			"PrivTotal", "PSSNative", "PSSDalvik", "PSSTotal",
			"HeapAllocNative", "HeapAllocDalvik", "HeapAllocTotal","HeapSizeNative", "HeapSizeDalvik", "HeapSizeTotal" };
